...
export default function Home() {
  ...
  return (
    <main>
      <section className="hero">
        <nav className="nav shell">
          ...
          <div className="navLinks">
            ...
            <a className="navButton" href={DRIVE_FOLDER} target="_blank" rel="noreferrer">Open Drive ↗</a>
          </div>
        </nav>
        <div id="top" className="heroContent shell">
          ...
          <p>A curated collection of research papers, teaching materials, technical reports, notebooks and articles spanning robotics, artificial intelligence and engineering.</p>
          ...
          <div className="stats" aria-label="Library highlights">
            <div><strong>{documents.length}</strong><span>documents online</span></div>
      ...
      <section id="about" className="about"><div className="aboutInner shell"><div><span className="kicker light">About the collection</span><h2>Knowledge made open, useful and connected.</h2></div><div><p>This library brings together work in robotics, computer vision, artificial intelligence, embedded systems and engineering education.</p><p>The collection is intended for students, researchers, educators and practitioners. Original authorship and source attribution should always be preserved.</p><a href={DRIVE_FOLDER} target="_blank" rel="noreferrer">Visit the complete Google Drive archive ↗</a></div></div></section>
